...
import { Home as HomeIcon, Info, TrendingUp, Book, Shield, FileText } from "lucide-react";
...
const SidebarNav: React.FC<SidebarNavProps> = ({ isSidebarOpen, setIsSidebarOpen }) => (
  <>
    <aside
