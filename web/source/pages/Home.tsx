...
import { BarChart3, Users, Zap, Award, TrendingUp, Shield } from "lucide-react";
        ...
        <div className="w-full">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            {isPremium === false && (
              <Link
                to="/upgrade"
                className="px-8 py-4 border-2 border-white/30 text-white font-semibold rounded-2xl hover:bg-white hover:text-gray-900 transition"
              >
                Get Started
              </Link>
            )}
        ...
        <div className="bg-white/5 p-12 rounded-3xl max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center">
            {isPremium === false && (
              <Link
                to="/upgrade"
                className="px-10 py-4 bg-yellow-500/90 text-gray-900 font-semibold rounded-2xl hover:bg-yellow-400 transition"
              >
                Upgrade Now
              </Link>
            )}
